...
public class MiniGameIdentifyTask implements IResearchTask {
    public long requiredAmount;
    public long finishedCount;
    public MiniGameIdentifyTask(long requiredAmount) {
    ...
    public String getIdentifier() {
        return String.valueOf(ResearchGameTypes.Identify.ordinal());
    }

    @Override
    public String getDesc() {
        return String.format(LH.get("ktfru.research.task.minigame.identify"), requiredAmount);
    }
}
