...
public class MiniGameCurrentControlTask implements IResearchTask {
    public long requiredAmount;
    public long finishedCount;
    public MiniGameCurrentControlTask(long requiredAmount) {
    ...
    public String getIdentifier() {
        return String.valueOf(ResearchGameTypes.CurrentControl.ordinal());
    }

    @Override
    public String getDesc() {
        return String.format(LH.get("ktfru.research.task.minigame.current"), requiredAmount);
    }
}
