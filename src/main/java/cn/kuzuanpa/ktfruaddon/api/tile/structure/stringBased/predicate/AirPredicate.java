...
public class AirPredicate implements IStructurePredicate {
    @Override
    ...
    public boolean project(StructureContext ctx, int x, int y, int z) {
        kTFRUAddonARProjectorCompact.projectBlock(ctx.world, x,y,z,  new BlockMeta(Blocks.glass, 0, "ktfru.part.air"));
        return true;
    }
}
