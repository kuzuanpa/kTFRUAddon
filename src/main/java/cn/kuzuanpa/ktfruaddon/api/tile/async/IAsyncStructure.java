...
public interface IAsyncStructure {
    ...
    boolean asyncCheckStructure(AsyncStructureManager.WorldContainer ctx, ChunkCoordinates aClickedAt, Entity aPlayer, IInventory aInventory);

    static boolean checkAndSetTarget(AsyncStructureManager.WorldContainer worldContainer, ITileEntityMultiBlockController aController, ChunkCoordinates coord, TileDesc[] availTiles, boolean loadChunk, ChunkCoordinates aClickedAt, Entity aPlayer, IInventory aInventory) {
