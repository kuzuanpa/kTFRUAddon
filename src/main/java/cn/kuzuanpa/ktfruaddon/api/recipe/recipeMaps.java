...
public class recipeMaps {
    public static final Recipe.RecipeMap
            ...
            , HeatMixer               = new Recipe.RecipeMap(null, "ktfru.recipe.heatmixer"              , "Heat Mixer"                , null, 0, 1, RES_PATH_GUI + "machines/HeatMixer",                6, 3, 0, 6, 3, 0,  1,  1, "", 1, "", F, T, T, T, T, F, T, T)
            ...
            , Assembler               = new Recipe.RecipeMap(null, "ktfru.recipe.assembler"              , "Circuit Assembler"         , null, 0, 1, RES_PATH_GUI + "machines/Assembler",                9, 3, 1, 1, 0, 0,  1,  1, "", 1, "", F, T, T, T, T, F, T, T)
            ...
            , FuelDeburner            = new Recipe.RecipeMap(null, "ktfru.recipe.fueldeburner"           , "Fuel Deburner"             , null, 0, 1, RES_PATH_GUI + "machines/FuelDeburner",             3, 3, 0, 6, 6, 0,  1,  1, "Best: ", 1, "K", F, T, T, T, T, F, T, T)
            ...
            , CrucibleModel           = new Recipe.RecipeMap(null, "ktfru.recipe.fake.cruciblemodel"     , "Crucible Model"            , null, 0, 1, RES_PATH_GUI + "machines/CrucibleModel",            2, 1, 2, 0, 0, 0,  2,  1, "", 1, "", F, F, T, F, F, F, T, T)
            , QuantumPetrochem        = new Recipe.RecipeMap(null, "ktfru.recipe.quantum.petrochem"      , "Quantum Petrochemical"     , null, 0, 1, RES_PATH_GUI + "machines/QuantumPetrochem",         1, 0, 0, 3, 6, 0,  1,  1, "", 1, "", F, F, T, F, F, F, T, T)
