...
public class recipeMaps {
    public static final Recipe.RecipeMap
            ...
            , RocketAssembler         = new Recipe.RecipeMap(null, "ktfru.recipe.rocket.assembler"       , "Rocket Assembler"          , null, 0, 1, RES_PATH_GUI + "machines/Assembler",                9, 3, 1, 3, 0, 0,  1,  1, "", 1, "", T, T, T, T, T, F, T, T)
