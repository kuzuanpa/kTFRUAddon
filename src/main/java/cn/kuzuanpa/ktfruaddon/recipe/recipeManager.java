...
public class recipeManager {
    ...
    , MaskAligner             = new Recipe.RecipeMap(null, "ktfru.recipe.maskaligner"            , "Mask Aligner"              , "Mask Aligner",                0, 1, RES_PATH_GUI + "machines/MaskAligner",              3, 3, 1, 3, 3, 0,  1,  1, "", 1, "", T, T, T, T, F, F, F)
