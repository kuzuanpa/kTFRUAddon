...
public class recipeManager {
    ...
    , AcidMixer               = new Recipe.RecipeMap(null, "ktfru.recipe.acidmixer"              , "Acid Mixer"                , "Acid Mixer",                  0, 1, RES_PATH_GUI + "machines/AcidMixer",                6, 2, 0, 6, 2, 0,  2,  1, "", 1, "", T, T, T, T, F, T, T)
    , AlkaliMixer             = new Recipe.RecipeMap(null, "ktfru.recipe.alkalimixer"            , "Alkali Mixer"              , "Alkali Mixer",                0, 1, RES_PATH_GUI + "machines/AlkaliMixer",              6, 2, 0, 6, 2, 0,  2,  1, "", 1, "", T, T, T, T, F, T, T)
    ...
    , AcidHeatMixer           = new Recipe.RecipeMap(null, "ktfru.recipe.acidheatmixer"          , "Acid Heat Mixer"           , "Acid Heat Mixer",             0, 1, RES_PATH_GUI + "machines/AcidHeatMixer",            6, 2, 0, 6, 2, 0,  2,  1, "", 1, "", T, T, T, T, F, T, T)
    , AlkaliHeatMixer         = new Recipe.RecipeMap(null, "ktfru.recipe.alkaliheatmixer"        , "Alkali Heat Mixer"         , "Alkali Heat Mixer",           0, 1, RES_PATH_GUI + "machines/AlkaliHeatMixer",          6, 2, 0, 6, 2, 0,  2,  1, "", 1, "", T, T, T, T, F, T, T)
    , PressureMixer           = new Recipe.RecipeMap(null, "ktfru.recipe.pressuremixer"          , "Pressure Mixer"            , "Pressure Mixer",              0, 1, RES_PATH_GUI + "machines/PressureMixer",            6, 2, 0, 6, 2, 0,  2,  1, "", 1, "", T, T, T, T, F, T, T)
    , AcidPressureMixer       = new Recipe.RecipeMap(null, "ktfru.recipe.acidpressuremixer"      , "Acid Pressure Mixer"       , "Acid Pressure Mixer",         0, 1, RES_PATH_GUI + "machines/AcidPressureMixer",        6, 2, 0, 6, 2, 0,  2,  1, "", 1, "", T, T, T, T, F, T, T)
    , AlkaliPressureMixer     = new Recipe.RecipeMap(null, "ktfru.recipe.alkalipressuremixer"    , "Alkali Pressure Mixer"     , "Alkali Pressure Mixer",       0, 1, RES_PATH_GUI + "machines/AlkaliPressureMixer",      6, 2, 0, 6, 2, 0,  2,  1, "", 1, "", T, T, T, T, F, T, T)
    , PTFEPressureMixer       = new Recipe.RecipeMap(null, "ktfru.recipe.ptfepressuremixer"      , "PTFE Pressure Mixer"       , "PTFE Pressure Mixer",         0, 1, RES_PATH_GUI + "machines/PTFEPressureMixer",        6, 2, 0, 6, 2, 0,  2,  1, "", 1, "", T, T, T, T, F, T, T)
    , PressureHeatMixer       = new Recipe.RecipeMap(null, "ktfru.recipe.pressureheatmixer"      , "Pressure Heat Mixer"       , "Pressure Heat Mixer",         0, 1, RES_PATH_GUI + "machines/PressureHeatMixer",        6, 2, 0, 6, 2, 0,  2,  1, "", 1, "", T, T, T, T, F, T, T)
    , AcidPressureHeatMixer   = new Recipe.RecipeMap(null, "ktfru.recipe.acidpressureheatmixer"  , "Acid Pressure Heat Mixer"  , "Acid Pressure Heat Mixer",    0, 1, RES_PATH_GUI + "machines/AcidPressureHeatMixer",    6, 2, 0, 6, 2, 0,  2,  1, "", 1, "", T, T, T, T, F, T, T)
    , AlkaliPressureHeatMixer = new Recipe.RecipeMap(null, "ktfru.recipe.alkalipressureheatmixer", "Alkali Pressure Heat Mixer", "Alkali Pressure Heat Mixer",  0, 1, RES_PATH_GUI + "machines/AlkaliPressureHeatMixer",  6, 2, 0, 6, 2, 0,  2,  1, "", 1, "", T, T, T, T, F, T, T)
    ...
    , LaserCutter             = new Recipe.RecipeMap(null, "ktfru.recipe.lasercutter"            , "Laser Cutter"              , "Laser Cutter",                0, 1, RES_PATH_GUI + "machines/LaserCutter",              1, 3, 1, 0, 0, 0,  1,  1, "", 1, "", T, T, T, T, F, F, F)
