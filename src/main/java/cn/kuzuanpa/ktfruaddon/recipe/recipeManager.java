...
public class recipeManager {
    public static final Recipe.RecipeMap
            ...
            , FusionTokamak           = new Recipe.RecipeMap(null, "ktfru.recipe.fusion.tokamak"         , "Tokamak Fusion"            , "Tokamak Fusion"      ,        0, 1, RES_PATH_GUI + "machines/FusionTokamak",            3, 3, 0, 3, 3, 1,  1,  1, "Start: ", 1, "", T, T, T, T, F, F, F)
