...
public class recipeManager {
    public static final Recipe.RecipeMap
            ...
            , ChemicalVaporDepositor = new Recipe.RecipeMap(null, "ktfru.recipe.cvd"              , "Chemical Vapor Depositor",  "Chemical Vapor Depositor", 0, 1, RES_PATH_GUI+ "machines/ChemicalVaporDepositor", /*IN-OUT-MIN-ITEM=*/ 6, 3, 0,/*IN-OUT-MIN-FLUID=*/ 1, 6, 0,/*MIN*/ 1,/*AMP=*/ 1, "",    1, ""      , T, T, T, T, F, F, F)
