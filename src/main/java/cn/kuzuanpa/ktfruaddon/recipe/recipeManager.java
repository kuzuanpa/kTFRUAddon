...
public class recipeManager {
    ...
    , Ionizer                = new Recipe.RecipeMap(null, "ktfru.recipe.ionizer"            , "Ionizer"                   , "Ionizer", 0, 1, RES_PATH_GUI+"machines/Ionizer"                   ,/*IN-OUT-MIN-ITEM=*/ 1, 1, 0,/*IN-OUT-MIN-FLUID=*/ 1, 1, 0,/*MIN*/ 1,/*AMP=*/ 1, ""   ,    1, ""      , T, T, T, T, F, F, F)
    ...
    , CVD                    = new Recipe.RecipeMap(null, "ktfru.recipe.cvd"                , "Chemical Vapor Depositor"  , "Chemical Vapor Depositor", 0, 1, RES_PATH_GUI+ "machines/ChemicalVaporDepositor", /*IN-OUT-MIN-ITEM=*/ 6, 3, 0,/*IN-OUT-MIN-FLUID=*/ 1, 6, 0,/*MIN*/ 1,/*AMP=*/ 1, "",    1, ""      , T, T, T, T, F, F, F)
