...
public class Circuits {
    public static void init(){
        ...
        recipeManager.Assembler.addRecipeX(F,256 ,120,ST.array(IL.Circuit_Part_Advanced.get(4),IL.Circuit_Plate_Gold.get(1),     ItemList.CoilT2.get(2),ItemList.CapacitorT2.get(6),ItemList.ResistanceT2.get(12),ItemList.DiodeT1.get(2)), FL.array(flList.MoltenTeflon.make(72)),ZL_FS, IL.Circuit_Board_Advanced.get(1));
        recipeManager.Assembler.addRecipeX(F,512 ,120,ST.array(IL.Circuit_Part_Elite.get(4),   IL.Circuit_Plate_Gold.get(1),     ItemList.CoilT2.get(4),ItemList.CapacitorT2.get(8),ItemList.ResistanceT2.get(20),ItemList.DiodeT1.get(2)), FL.array(flList.MoltenTeflon.make(72)),ZL_FS, IL.Circuit_Board_Elite.get(1));
