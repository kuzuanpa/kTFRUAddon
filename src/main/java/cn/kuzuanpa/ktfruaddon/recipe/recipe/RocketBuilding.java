...
public class RocketBuilding {
    public static void init(){
        ...
        recipeMaps.Assembler.addRecipeX(F,320,480, ST.array(ItemList.ComputerGT1000.get(2), OP.wireFine.mat(MT.Ag, 4), IL.ROBOT_ARMS[4].get(4), IL.SENSORS[4].get(1),OP.casingMachine.mat(MT.Ti, 1)), FL.array(MT.SolderingAlloy.liquid(U,false)),ZL_FS, GTTileEntityRegistry.ktfruaddon.getItem(30035));
        recipeMaps.Assembler.addRecipeX(F,320,480, ST.array(ItemList.ComputerGT1090.get(2), OP.wireFine.mat(MT.Ag, 4), IL.ROBOT_ARMS[4].get(4), IL.SENSORS[4].get(1),OP.casingMachine.mat(MT.Ti, 1)), FL.array(MT.SolderingAlloy.liquid(U,false)),ZL_FS, GTTileEntityRegistry.ktfruaddon.getItem(30035));
        recipeMaps.Assembler.addRecipeX(F,320,480, ST.array(ItemList.UnderClockedModerateComputer.get(2), OP.wireFine.mat(MT.Ag, 4), IL.ROBOT_ARMS[4].get(4), IL.SENSORS[4].get(1),OP.casingMachine.mat(MT.Ti, 1)), FL.array(MT.SolderingAlloy.liquid(U,false)),ZL_FS, GTTileEntityRegistry.ktfruaddon.getItem(30035));
