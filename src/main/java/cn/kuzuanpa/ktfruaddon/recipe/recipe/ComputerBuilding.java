...
//Make Boule 制作单晶硅 HU
        ...
        RM.CrystallisationCrucible.addRecipe1(T,16,72000, new long[]{8000},OP.dustDiv72.mat(MT.Si,1),FL.array(FL.Helium.make(80000),flList.Silane.make(4000)),FL.array(ZL_FS),ItemList.SiliconBoulePure.get(1));
...
//Cut Boule to plate 切割单晶硅 LU
        ...
        recipeMaps.LaserCutter.addRecipeX(T,512,2000, ST.array(ItemList.SiliconBoulePure.get(1)),FL.array(ZL_FS),FL.array(ZL_FS), ItemList.SiliconPlateT2.get(9));
...
//Coat 涂胶 EU
        ...
        recipeMaps.WaferCoater.addRecipeX(T,240,200, ST.array(ItemList.SiliconPlateOxidizedT2.get(1)),FL.array(flList.DNQPhotoresist.make(100)),FL.array(ZL_FS), ItemList.SiliconPlateCoatedT2.get(1));
