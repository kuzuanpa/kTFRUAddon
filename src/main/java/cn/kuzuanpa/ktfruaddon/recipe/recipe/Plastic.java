...
public class Plastic {
    public static void init(){
        ...
        recipeMaps.HeatMixer          .addRecipe2(F,140,110,matList.DiphenylCarbonate.getDust(1),matList.BPA.getDust(1),ZL_FS,ZL_FS,OP.dust.mat(MT.Polycarbonate,2));
        ...
        recipeMaps.HeatMixer          .addRecipe1(F,256,10,OP.dust.mat(matList.CalciumAcetate.mat, 1),ZL_FS,flList.Acetone.make(500),OP.dust.mat(MT.CaCO3,1));
        ...
        recipeMaps.HeatMixer          .addRecipe0(F,110,110,FL.array(flList.SolutionBPASodium.make(1000),flList.Phosgene.make(200),flList.Dichloromethane.make(200)),ZL_FS,OP.dust.mat(MT.Polycarbonate,2));

        recipeMaps.HeatMixer          .addRecipe1(F,142,380,OP.dust.mat(MT.Zn,1),FL.array(MT.HF.gas(16*U10,false),flList.Chloroform.make(400)),FL.array(flList.Tetrafluoroethylene.make(400),MT.HCl.gas(2*U,false)),matList.ZincChloride.getDust(3));
        ...
        recipeMaps.HeatMixer          .addRecipe2(F,320,120,matList.BPA.getDust(1),OP.dust.mat(MT.NaOH,2),FL.array(flList.Epichlorohydrin.make(1000)),FL.array(FL.Saltwater.make(800)),matList.EpoxyResin.getDust(6));
        ...
        RM.           Mixer              .addRecipe0(F,250,120,FL.array(MT.H2SO4.liquid(0,false),flList.Phenol.make(1000),flList.Formaldehyde.make(1000)),ZL_FS,OP.dust.mat(MT.Bakelite,8));
        recipeMaps.HeatMixer          .addRecipe1(F,180,120,OP.dust.mat(MT.NaOH,0),FL.array(flList.Phenol.make(1000),flList.Formaldehyde.make(1000)),ZL_FS,OP.dust.mat(MT.Bakelite,8));

        recipeMaps.HeatMixer          .addRecipe1(F,210,100,OP.dust.mat(MT.Mg,1),FL.array(flList.Chloromethane.make(300),flList.Methoxymethane.make(0)),FL.array(flList.MethylmagnesiumChloride.make(300)),ZL_IS);
        ...
        recipeMaps.HeatMixer          .addRecipe0(F,256,120,FL.array(flList.DichloroEthane.make(100)),FL.array(flList.VinylChloride.make(100),MT.HCl.gas(U10,false)),ZL_IS);
        ...
        recipeMaps.HeatMixer          .addRecipe0(F,0,1600,FL.array(flList.HexaFluoroPropylene.make(100),FL.Oxygen.make(100),flList.Benzene.make(0)),FL.array(flList.HFPO.make(100)),ZL_IS);
        ...
        recipeMaps.HeatMixer          .addRecipe1(F,262,140,matList.VinylAcetate.getDust(1),FL.array(MT.H2O2.liquid(5*U100,false),flList.Methanol.make(0)),FL.array(FL.Water.make(50)),OP.dust.mat(matList.PolyVinylAcetate.get(),1));
