...
public class Plastic {
    public static void init(){
        ...
        RM.           Mixer              .addRecipe1(F,120,620,matList.MercuryIIChloride.getDust(0),FL.array(MT.HCl.gas(U10,false),flList.Acetylene.make(100)),FL.array(flList.VinylChloride.make(100)),ZL_IS);

        RM.           Mixer              .addRecipe0(F,120,620,FL.array(FL.BioEthanol.make(100),MT.Cl.gas(U10,false),FL.Oxygen.make(50)),FL.array(flList.VinylChloride.make(200),FL.Water.make(100)),ZL_IS);
