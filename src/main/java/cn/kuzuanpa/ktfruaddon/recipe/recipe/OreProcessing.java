...
public class OreProcessing {
  ...
  //Cr processing
        //Use NH3
        RM.Bath.addRecipeX(T,0, 512 , ST.array(OM.dust(MT.OREMATS.Chromite, U*2), OM.dust(matList.Sulfanilamide.get(), U*9)), FL.array(MT.H2SO4.liquid(6000,T)), FL.array(FL.Water.make(4000)), OM.dust(matList.AmmoniumChromicSulfate.get(), U*6), OM.dust(OreDictMaterial.get(30013), U*3));
        ...
        HeatMixer.addRecipeX(T,120,80,ST.array(OM.dust(MT.CaCO3,U),OM.dust(MT.Na2CO3,U *2), OM.dust(MT.OREMATS.Bauxite,U)),ZL_FS,FL.CarbonDioxide.make(3000),OM.dust(OreDictMaterial.get(30020),U*2));
        ...
        //Step2
        RM.Bath.addRecipeX(T, 0, 180, ST.array(OM.dust(OreDictMaterial.get(30020),U*2),OM.dust(MT.NaOH,U*2)),FL.array(MT.H2O.liquid(1000 ,T)),FL.array(FL.make(flList.SodiumAluminate.name,2000)),OM.dust(MT.SiO2,U4),OM.dust(OreDictMaterial.get(30022),U));
     ...
     //W Process
        ...
        RM.Autoclave.addRecipe2(T, 0, 400,new long[]{10000},OP.dust.mat(MT.OREMATS.Tungstate,1),OP.dust.mat(MT.Na2CO3,2),FL.Steam.make(20000),FL.make(flList.SodiumHeterotungstate.name,2000),OM.dust(OreDictMaterial.get(30030), U));
