...
public class OreProcessing {
  ...
  //Cr processing
        ...
        RM.Bath.addRecipeX(T, 0, 80, ST.array(OM.dust(MT.OREMATS.Bauxite,U)),FL.array(MT.H2SO4.liquid(U *4 ,T)),FL.array(FL.make("acidpickledbauxide",2000)),OM.dust(MT.SiO2,U));
