...
public class DreamPool {
    public Predicate<ITransmittable> AbstractOverallCondition = t -> false;
    public List<AbstractTransmittable> abstractTransmittableList = new ArrayList<>();

    public void updateAbstractCondition(){
        abstractTransmittableList.forEach(abs-> AbstractOverallCondition = AbstractOverallCondition.or(abs.getCondition()));
    }
