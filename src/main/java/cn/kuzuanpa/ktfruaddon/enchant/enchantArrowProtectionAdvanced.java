...
public class enchantArrowProtectionAdvanced extends EnchantmentProtection {
    public static enchantArrowProtectionAdvanced INSTANCE;

    public enchantArrowProtectionAdvanced(String name, int id) {
    ...
    public int calcModifierDamage(int level, DamageSource p_77318_2_)
    {
        ...
        else
        {
            ...
            return p_77318_2_.isProjectile() ? MathHelper.floor_float(f * 1.5F) : 0;
        }
    }
    @Override
    public String getName() {
        return "enchantment.protection.advanced.Projectile";
    }
}
