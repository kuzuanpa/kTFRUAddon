...
public class ResearchTrees {
    public static void init() {
        ResearchTree.ResearchTreeTemplate.put((byte) 0, tree -> {
                    ...
                    ResearchProject g = new ResearchProject(tree, "电弧处理", "你的记忆中总能见到电弧，但如何利用它而不损坏材料，需要你进一步研究", Items.paper, 0, 5)
                            .setPos(340, 10)
                            .addPrerequisite(f);

                    ResearchProject h = new ResearchProject(tree, "高压容器", "许多处理需要高压环境，通过研究常见材料在高压下的变化来制造耐压容器", Items.paper, 0, 5)
                            .setPos(340, 10)
                            .addPrerequisite(f);
                    ...
                    ResearchProject j = new ResearchProject(tree, "电池原理", "利用已知的电解原理进行电力储存", Items.paper, 0, 5)
                            .setPos(340, 10)
                            .addPrerequisite(f);
