...
public class ContainerCommonIdentify extends ContainerCommonDefault {
    public ContainerCommonIdentify(InventoryPlayer aInventoryPlayer, ITileEntityInventoryGUI aTileEntity, int aGUIID) {
