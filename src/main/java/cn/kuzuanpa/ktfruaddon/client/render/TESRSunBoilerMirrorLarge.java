...
public class TESRSunBoilerMirrorLarge extends TileEntitySpecialRenderer {
    IModelCustom model = AdvancedModelLoader.loadModel(new ResourceLocation("ktfruaddon:models/sunboiler/mirror_large.obj"));
    ...
    public TESRSunBoilerMirrorLarge() {
    ...
    public void renderTileEntityAt(TileEntity til, double x,
        ...
        if (! (til instanceof SunHeaterMirrorLarge)) return;
        SunHeaterMirrorLarge tile = (SunHeaterMirrorLarge)til;
