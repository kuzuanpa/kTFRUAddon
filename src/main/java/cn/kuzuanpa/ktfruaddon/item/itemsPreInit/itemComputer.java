...
public class itemComputer extends MultiItemRandom {
    ...
    private static final long[] ComputePower ={3,4,84,102,653,816,3422,4037,10289,12554,18132,25633,30568,65130,45311,53312,110023,80632,91131,183077,73909,156657,102563,238567,2,102,416,3412,11239,32623};
    @Override
