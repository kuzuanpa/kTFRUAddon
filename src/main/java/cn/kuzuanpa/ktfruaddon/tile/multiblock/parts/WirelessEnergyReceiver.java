...
public class WirelessEnergyReceiver extends TileEntityBase09FacingSingle implements IMultiBlockPart, ITileEntityEnergy, ITileEntitySwitchableOnOff {
    ...
    public void readFromNBT2(NBTTagCompound aNBT) {
        ...
        if (CODE_CLIENT) {
            if (GT_API.sBlockIcons == null && aNBT.hasKey(NBT_TEXTURE)) {
                ...
                if (tCanonicalTileEntity instanceof WirelessEnergyReceiver) {
                    sTextureCommon = ((WirelessEnergyReceiver) tCanonicalTileEntity).sTextureCommon;
                    sOverlayFront = ((WirelessEnergyReceiver) tCanonicalTileEntity).sOverlayFront;
    ...
    public String getTileEntityName() {
        return "ktfru.multitileentity.part.wireless.receiver";
    }
