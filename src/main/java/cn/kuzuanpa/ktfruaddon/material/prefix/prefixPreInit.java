...
public class prefixPreInit {
    public prefixPreInit(FMLPreInitializationEvent e){
 ...
 //       prefixUltraPure.setCondition(OreDictPrefixCondition.tagnor(TD.Properties.INVALID_MATERIAL,TD.Properties.DONT_SHOW_THIS_COMPONENT,TD.Properties.UNUSED_MATERIAL)); // The Condition under which Items of this Prefix should generate in general. In this case TRUE to have ALL the Items.
