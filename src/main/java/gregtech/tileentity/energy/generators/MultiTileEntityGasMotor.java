 ...
 */
public class MultiTileEntityGasMotor extends TileEntityBase09FacingSingle implements IFluidHandler, ITileEntityFunnelAccessible, ITileEntityTapAccessible, ITileEntityEnergy, ITileEntityRunningActively, ITileEntityAdjacentOnOff {
    ...
    public void readFromNBT2(NBTTagCompound aNBT) {
        ...
        mTanks[0].readFromNBT(aNBT, NBT_TANK+".0").setCapacity(mRate * 15);
        mTanks[1].readFromNBT(aNBT, NBT_TANK+".1").setCapacity(mRate * 15);
    }
